...
const prestamista_controller_1 = require("./prestamista.controller");
...
exports.PrestamistaModule = PrestamistaModule = __decorate([
    (0, common_1.Module)({
        ...
        controllers: [prestamista_controller_1.PrestamistaController],
        providers: [prestamista_service_1.PrestamistaService],
